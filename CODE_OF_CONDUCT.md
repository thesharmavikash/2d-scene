...
Sometimes, participants violating the Code of Conduct are unaware that their behavior is harmful, and an open conversation clears things up to move forward. However, if a participant continues with the behavior, the 2D Scene team may take any action they deem appropriate, up to and including expulsion from all 2D Scene spaces and identification of the participant as a harasser to other 2D Scene members or the general public.
